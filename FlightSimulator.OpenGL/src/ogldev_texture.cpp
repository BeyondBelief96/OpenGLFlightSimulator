...
TextureLoader::TextureLoader(GLenum TextureTarget)
{
    m_textureTarget = TextureTarget;
}


void TextureLoader::Load(GLuint BufferSize, void* pData)
{
...
void TextureLoader::LoadRaw(int Width, int Height, int BPP, unsigned char* pData)
{
    m_imageWidth = Width;
...
void TextureLoader::LoadInternal(void* image_data)
{
